...
const HomeSec2 = () => {
  return (
    <>
        ...
        <div className='flex justify-center gap-5 items-center flex-wrap flex-row-reverse mt-[-25vh] max-[900px]:mt-[5vh] mx-5'>
      ...
      <div className='flex justify-center gap-5 items-center mt-[-28vh] max-[900px]:mt-[5vh] flex-wrap mx-5'>
        ...
        <div className='flex justify-center gap-5 items-center flex-wrap flex-row-reverse mt-[-25vh] max-[900px]:mt-[10vh] mx-5'>
          <div className='flex flex-col items-end'>
      ...
      <div className='flex justify-center gap-5 items-center mt-[-18vh] max-[900px]:mt-[10vh] flex-wrap mx-5'>
        ...
        <div className='flex justify-center gap-5 items-center flex-wrap flex-row-reverse mt-[-25vh] max-[830px]:mt-[10vh] mx-5'>
          <div className='flex flex-col items-end'>
